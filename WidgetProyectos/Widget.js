...
/*
    ...
    */
    ...
    _defaultTableGeneral: function() {
      try {
        let checkboxDepartamento = query(".widget-proyectos table tbody tr td input");
    ...
    _activeTabSearch: function(positionTab) {
      ...
      let tabs1 = document.querySelectorAll('.widget-proyectos .tabs li');
      let tabsContent1 = document.querySelectorAll('.widget-proyectos .tab-content');

      let deactvateAllTabs1 = function () {
          tabs1.forEach(function (tab) {
            tab.classList.remove('is-active');
          });
      };

      let hideTabsContent1 = function () {
