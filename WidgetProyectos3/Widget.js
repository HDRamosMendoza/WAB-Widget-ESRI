...
function(
  ...
  return declare([BaseWidget], {
    ...
    _onClickDistrito: function(){
      try {
        ...
        if(this.CboProvincia.value != "") {
          ...
          this._zoomDistrito(
            this.CboDistrito.options[this.CboDistrito.selectedIndex].getAttribute("data-objectId"),
    ...
    _onClickProvincia: function(){
      try {
        ...
        if(this.CboProvincia.value.trim() != "") {
          ...
          //thisValue.style["background-color"] = "#D6DDEB";
          this._zoomProvincia(
            this.CboProvincia.options[this.CboProvincia.selectedIndex].getAttribute("data-objectId"),
            this.ID_ZoomEspecifico.checked
          );
          // Load - Provincia
          //this.CboDepartamento.options[this.CboDepartamento.selectedIndex].getAttribute("data-objectId"),
          this.queryDistrito.where = ""
            + this.distrito.IDDEPARTAMENTO + " = '" + this.CboDepartamento.value + "' AND "
            + this.distrito.IDPROVINCIA + " = '" + this.CboProvincia.value  + "'";
    ...
    _defaultTableGeneral: function() {
      try {
        let checkboxDepartamento = query(".widget-proyectos3 .limite-content .limite input");
...
/*
    ...
    _activeTabSearch: function(positionTab) {
      let tabs3 = document.querySelectorAll('.widget-proyectos3 .tabs li');
      let tabsContent3 = document.querySelectorAll('.widget-proyectos3 .tab-content');
